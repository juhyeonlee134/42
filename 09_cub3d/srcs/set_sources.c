...
/*   Updated: 2024/03/22 03:34:26 by juhyelee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_id	__get_id(char const *string)
{
	if (ft_strncmp(string, "NO", 2) == 0 && string[2] == ' ')
		return (E_NO);
	if (ft_strncmp(string, "SO", 2) == 0 && string[2] == ' ')
		return (E_SO);
	if (ft_strncmp(string, "WE", 2) == 0 && string[2] == ' ')
		return (E_WE);
	if (ft_strncmp(string, "EA", 2) == 0 && string[2] == ' ')
		return (E_EA);
...
void	__set_color(unsigned char *color, char const *string)
{
	...
	color[0] = ft_atoi(string);
	while (ft_isdigit(*string))
		string++;
	string++;
	color[1] = ft_atoi(string);
	while (ft_isdigit(*string))
		string++;
	string++;
	color[2] = ft_atoi(string);
}
